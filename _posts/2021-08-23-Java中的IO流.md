...
![files文件数组里面数组下标索引对应的文件如图所示：](https://img-blog.csdnimg.cn/2ed65556d2024f778f515fc5304764af.png)

temp文件夹文件按照数字递增排序，这个顺序与我们的分割顺序是一致的。合并时必须按照这个顺序。
![在这里插入图片描述](https://img-blog.csdnimg.cn/3ac368aaa78e4b06b6303ba1ea009e05.png)
